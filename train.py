...
def main():
    ...
    parser.add_argument("--wg-poisson-lambda", type=float, default=200.0, help="Legacy: arrivals-only poisson lambda for workload generator.")
    parser.add_argument("--wg-poisson-lambdas4", type=_parse_quad_floats, default=None, help="arrivals,duration,nodes,cores")
    parser.add_argument("--wg-max-jobs-hour", type=int, default=1500, help="Cap jobs/hour for the workload generator.")
    parser.add_argument("--wg-flat-targets4", type=_parse_quad_ints, default=None, help="arrivals,duration,nodes,cores")
    parser.add_argument("--wg-flat-jitters4", type=_parse_quad_ints, default=None, help="arrivals,duration,nodes,cores")
    parser.add_argument(
        "--wg-uniform-ranges4",
